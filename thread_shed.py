...
daily_transactions = daily_sales.replace(';,;', '_').split(',')
...
print('Total Sale Today = $ {}'.format(total_sales))

thread_sold_split = []

for sale in thread_hold:
...
for i in colors:
  print('Thread Shed sold {x} threads of {} thread today.'.format(i,x=colour_count(i)))
